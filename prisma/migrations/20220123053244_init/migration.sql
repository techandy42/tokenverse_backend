/*
  ...
  - You are about to drop the column `productKeyAccessTokenCategory` on the `nfts` table. All the data in the column will be lost.
...
DROP COLUMN "owner",
DROP COLUMN "productKeyAccessTokenCategory",
...
ADD COLUMN     "product_key_real_life_asset_category" "ProductKeyAccessTokenCategory" NOT NULL DEFAULT E'MISCELLANEOUS',
