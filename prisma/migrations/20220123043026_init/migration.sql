...
-- CreateEnum
CREATE TYPE "ProductKeyAccessTokenCategory" AS ENUM ('MISCELLANEOUS', 'CLOTHING_WEARABLE', 'BEAUTY_ACCESSORY', 'TOOL_EQUIPMENT', 'MATERIAL_MACHINE_PART', 'ELECTRONIC_APPLIANCE', 'GROCERY_FOOD', 'WEAPON', 'FURNITURE', 'REAL_ESTATE', 'TOY_GAME', 'HOME_SUPPLY', 'MEDICAL_MAGIC_ITEM');
...
ADD COLUMN     "productKeyAccessTokenCategory" "ProductKeyAccessTokenCategory" NOT NULL DEFAULT E'MISCELLANEOUS',
